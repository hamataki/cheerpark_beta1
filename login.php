...
<body>
    <div class="flex justify-center">
        <div class="w-full min-w-96 max-w-md p-5 rounded-xl bg-gray-50 text-gray-800">
            ...
            <form name="form1" action="login_act.php" method="post" class="space-y-6">
                ...
                <div class="space-y-1 text-sm">
                    ...
                    <input type="password" placeholder="Password" name="lpw" id="password" class="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-blue-600">
            ...
            <div class="flex items-center pt-4 space-x-1">
                <div class="flex-1 h-px sm:w-16 bg-gray-300"></div>
                <p class="px-3 text-sm text-gray-600">Login with social accounts</p>
                <div class="flex-1 h-px sm:w-16 bg-gray-300"></div>
            </div>
